import 'package:doctor_version/screens/home_page/home_page.dart';
import 'package:doctor_version/screens/login_page/components/inputField.dart';
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: 30),
                      InputField(
                        nameOfField: 'Enter Hospital Name',
                        obscureText: false,
                        typeOfField: TextInputType.text,
                      ),
                      SizedBox(height: 30),
                      InputField(
                        nameOfField: 'Enter Doctor Id',
                        obscureText: false,
                        typeOfField: TextInputType.text,
                      ),
                      SizedBox(height: 30),
                      InputField(
                        nameOfField: 'Enter Specialist Type',
                        obscureText: false,
                        typeOfField: TextInputType.text,
                      ),
                      SizedBox(height: 30),
